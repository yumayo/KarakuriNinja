...
void Circle::setRoute()
{
	...
	{
	case RouteType::ZEN:
		setValue(Vec2f(300, 300), Vec2f(300, env.getWindowHeight() - 300), Easing::EasingType::Linear, Easing::EasingType::Linear,//LEFT�̏ꍇ
			Vec2f(app::getWindowWidth() - 300, env.getWindowHeight() / 2.f), Vec2f(app::getWindowWidth() - 300, env.getWindowHeight() - 300), Easing::EasingType::Linear, Easing::EasingType::Linear);//RIGHT�̏ꍇ
		break;
	case RouteType::ZAI:
